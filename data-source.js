...
class BackupDataSource {
  ...
  normalizeFieldContract(input = {}) {
    ...
    return {
      ...
      inicio: firstDate("inicio", "fechaInicio", "fechaDesde", "vigenciaDesde", "vigenciaContratoDesde", "vigencia_contrato_desde", "vigencia contrato desde", "vigencia desde", "contratoDesde", "periodoDesde", "periodo desde", "desde", "start"),
      fin: firstDate("fin", "fechaFin", "fechaHasta", "vigenciaHasta", "vigenciaContratoHasta", "vigencia_contrato_hasta", "vigencia contrato hasta", "vigencia hasta", "contratoHasta", "periodoHasta", "periodo hasta", "hasta", "end"),
      frecuencia: (firstText("frecuencia", "frecuenciaBase", "frecuencia_base", "frecuencia base", "periodicidad", "formaPago", "forma_pago", "forma de pago") || "MENSUAL").toUpperCase(),
      vencimientoHabitual: firstText("vencimientoHabitual", "vencimiento_habitual", "vencimiento habitual", "vencimientoBase", "vencimiento_base", "diaVencimiento", "dia_vencimiento", "diaVto", "dia_vto", "vencimientoTexto", "vencimiento"),
